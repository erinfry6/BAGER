...
## Steps:
 ...
 4) Identify genes with expression shifts throughout the primate phylogeny by comparing the posterior probability distributions of the ancestral expression reconstructions. 
    - [Expression shifts in the frontal cortex](BrainIdentifyShiftsInAllLineages.html)
    - [Expression shifts testis](TestisIdentifyShiftsInAllLineages.html)
 
 5) Identify genes with expression shifts in the human lineage.
    - [Genes and pathways with expression shifts in the human frontal cortex](BrainBAGERAnalysis.html)
    - [Genes and pathways with expression shifts in human testis](TestisBAGERAnalysis.html)
