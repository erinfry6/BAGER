...
# Setup
## Define paths and load libraries, BADGER results, and gene information
...
## Load and Examine the Results from BADGER Analysis
...
Genes that succesfully reconstructed will have similar posterior variations between the two ancestral node reconstructions. Each reconstructions difference in standard deviation between the two ancestral nodes has been calculated. Only genes with a foldSD less than 4 will be included, as they have successfully reconstructed.
