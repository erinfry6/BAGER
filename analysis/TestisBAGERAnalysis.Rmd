...
## uploaded saved file 
Summary<-read.table(paste(pathResults,"2017-07-25BAGERSummary.txt", sep=""),sep='\t', header=T)
...
## remove rows from original data that were repeat ensemblids
TPM_log<-TPM_log[-(dup.ensembl-1),]
...
temp<-cbind(reconsgenes[-1,],human_mean, chimp_mean, HC_mean, non_human_mean)
